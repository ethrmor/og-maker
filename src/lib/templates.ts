...
export const EDITOR_FIELDS: FieldConfig[] = [
  ...
  // Positioning fields for builder template
  {
    key: "titleX",
  ...
  {
    key: "brandNameRotation",
    label: "Brand Rotation",
    type: "range",
    min: -180,
    max: 180,
    step: 5,
  ...
  // Background patterns (builder only)
  {
...
export const TEMPLATES: TemplateMeta[] = [
  {
    ...
    description: "Start from scratch, position everything freely",
    tags: ["custom", "flexible"],
    thumbnailGradient: "#0a0a0a",
    defaults: {
      accentColor: "#ffffff",
